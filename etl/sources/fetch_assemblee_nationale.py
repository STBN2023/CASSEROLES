...
# ── Carte siège → groupe (extraite du rendu navigateur, mars 2025, corrigée mars 2026) ──
# Chaque caractère correspond au siège n° = index dans la chaîne.
# Codes : G=GDR, L=LFI, S=SOC, E=ECO, I=LIOT, R=REN, D=DEM, H=HOR,
#          K=LR, U=UDR, N=RN, X=NI, _=séparateur/vacant
# Corrections mars 2026 : 19 sièges manquants ajoutés (Panot, Delogu, Woerth, etc.)
_SEAT_GROUP_MAP = (
    ...
    "HHHHH_HHHHHHHHHH_HHHHHHHHHHHHHHHH__RRRR_RRRRRRRRRRRRRRRRRRRRRR_RRRRRRR"  # 250:R (Woerth→REN)
    ...
    "SSSSSS_SSSSSSS_SSSSS_SSSSIIISS_SSSSIIIIII_SSSSS__IIIIIISSSSS__E__EEEEEEEEE"  # 522:E,530:E,536:L,546:L,557:L,564:S,576:G,580:L
    "EEEEEEEEEEEEEEEELLLEEEEELLLEEEEEELLLLLEEEELLLLLLSSSSSLLLLLLL_SSSSSSSLLLLL"  # 599:L,606:L,609:L,614:L,618:L,623:L,632:L,636:L,642:L,648:L
    "GGGGLGGGGGGGGGGGGGGLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL_LLLLL_LLLL"  # Lebon:GDR(576), all LFI seats filled
)
